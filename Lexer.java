...
public class Lexer {
	...
	int[][] delta = {
		...
		/*  P  X  0  1  A  OTHER */
		{ 1, -1, 4, 5 , 6, -1},// 状態0
		{-1, -1, 7, 7, -1, -1},// 状態1 状態0から、小数点を入力した場合
		{-1, -1, 2, 2,  6, -1},// 状態2 状態4から、0-9を入力した場合
		{-1, -1, 6, 6,  6, -1},// 状態3 状態4から、xを入力した場合
		{ 1,  3, 2, 2,  6, -1},// 状態4 状態0から、0を入力した場合
		{ 7, -1, 5, 5,  6, -1},// 状態5 状態0から、0-9を入力した場合
		{-1, -1, 6, 6,  6, -1},// 状態6 状態0,4,5から、a-fを入力した場合
									//  状態3から、0-9,a-fを入力した場合
		{-1, -1, 7, 7, -1, -1}//  状態7 状態1から、0-9を入力した場合
									//  状態2,5から、小数点を入力した場合
		/*...*/
	};
